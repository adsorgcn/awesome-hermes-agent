...
- **[stable]** [Mem-Forever](https://github.com/ilang-ai/Mem-Forever) by [I-Lang Protocol](https://github.com/ilang-ai) - Persistent memory across sessions and tools. Auto-generates a portable profile from conversation, saves decisions and lessons to `.ilang/`, applies preferences in every future session. Template repo — fork once, remember forever. Works across Hermes, Claude Code, Cursor, Codex, Copilot, and Gemini.
- **[stable]** [Imprint](https://github.com/ilang-ai/Imprint) by [I-Lang Protocol](https://github.com/ilang-ai) - Your habits, imprinted on AI. One skill replaces eleven: memory, onboarding, code review, debugging, planning, progress tracking, testing, git workflow, SEO, and copywriting. Learns how you work and applies it across every session and platform.
- **[stable]** [AutoCode](https://github.com/ilang-ai/AutoCode) by [I-Lang Protocol](https://github.com/ilang-ai) - You say it, AutoCode ships it. 47 skills covering understanding, planning, building, quality, debugging, deployment, and learning. Code to deployment in one session. I-Lang v3.0 powered.
